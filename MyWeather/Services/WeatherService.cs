...
namespace MyWeather.Services
{
    ...
    public class WeatherService
    {
       ...
       // const string Uri = "http://dev.dragonflyathletics.com:1337/api/dfkey/events/59d2bd5a2b92b0ceeed8eec7/status/anything";
        const string Uri = "http://10.0.2.2:8090/helloapi";

        public async Task<WeatherRoot> GetWeather(double latitude, double longitude, Units units = Units.Imperial)
        {
        var handler = new HttpClientHandler {Credentials = new NetworkCredential("athadamatha", "QazPlm@0958")};
